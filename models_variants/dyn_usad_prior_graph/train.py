"""训练: Dynamic USAD + Prior Graph (先验图替代静态Pearson)"""
...
from variant_model import DynPriorGraph_USAD
...
def main():
    ...
    save_dir = os.path.join(cfg["output"]["save_dir"], "dyn_usad_prior_graph")
    ensure_dir(save_dir)
