"""训练: Dynamic Pearson + Multi-Scale TCN + USAD"""
...
from variant_model import DynMS_USAD
...
def main():
    ...
    save_dir = os.path.join(cfg["output"]["save_dir"], "dyn_ms_usad")
    ensure_dir(save_dir)
