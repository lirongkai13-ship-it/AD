"""Train v1 tri_branch with learnable gamma"""
...
def main():
    ...
    save_dir = os.path.join(cfg["output"]["save_dir"], "tri_branch_v1_learnable_gamma")
    ensure_dir(save_dir)
    ...
    print(f"Gamma: learnable, init=0.05")
    ...
    for epoch in range(1, epochs + 1):
        ...
        print(f"Epoch {epoch:03d} (P{phase}) | train {train_loss:.6f} | val {val_loss:.6f} | gamma {gamma_val:.6f}")
    ...
    print(f"\n=== v1 learnable gamma (final={final_gamma:.6f}) ===")
