...
from models_variants.tri_branch_v6.variant_model import TriBranch_USAD_v6
...
def main():
    ...
    save_dir = os.path.join(cfg["output"]["save_dir"], "tri_branch_v6"); ensure_dir(save_dir)
    ...
    print(f"v6: v5 + FFN, params={sum(p.numel() for p in model.parameters()):,}")
    ...
    print(f"\n=== v6 (v5+FFN, gamma={final_gamma:.4f}) ===")
