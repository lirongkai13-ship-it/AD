"""训练: Parallel Spatial-Temporal + Multi-Scale Temporal + Prior Graph + USAD"""
...
from variant_model import ParallelMS_USAD
...
def main():
    ...
    save_dir = os.path.join(cfg["output"]["save_dir"], "parallel_usad_ms")
    ensure_dir(save_dir)
    ...
    print(f"\n=== Parallel + Multi-Scale Temporal + Prior + USAD ===")
