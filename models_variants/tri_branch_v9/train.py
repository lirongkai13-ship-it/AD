...
from models_variants.tri_branch_v9.variant_model import TriBranch_USAD_v9
...
def main():
    ...
    save_dir = os.path.join(cfg["output"]["save_dir"], "tri_branch_v9"); ensure_dir(save_dir)
    ...
    print(f"v9: v5 + CLS token, params={sum(p.numel() for p in model.parameters()):,}")
    ...
    print(f"\n=== v9 (CLS token, gamma={final_gamma:.4f}) ===")
