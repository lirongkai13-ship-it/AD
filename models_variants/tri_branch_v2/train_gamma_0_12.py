"""Train tri_branch_v2 with gamma=0.12 fixed"""
...
def main():
    ...
    save_dir = os.path.join(cfg["output"]["save_dir"], "tri_branch_v2_gamma_0_12")
    ensure_dir(save_dir)
    ...
    metrics = {"threshold": threshold, "raw": raw_m, "point_adjust": pa_m, "train_time_min": train_time/60}
