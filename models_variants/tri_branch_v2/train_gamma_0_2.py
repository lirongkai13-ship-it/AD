"""Train tri_branch_v2 with gamma=0.2 fixed"""
...
def main():
    ...
    save_dir = os.path.join(cfg["output"]["save_dir"], "tri_branch_v2_gamma_0_2")
    ensure_dir(save_dir)
    ...
    model = TriBranch_USAD_v2(
        ...
        gamma_mode="fixed", gamma_value=0.2, gate_scale=1.0,
