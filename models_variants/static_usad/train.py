"""训练: 静态 Pearson + USAD 双解码器（对照 dynamic_usad）"""
...
from variant_model import Static_USAD
...
def main():
    ...
    save_dir = os.path.join(cfg["output"]["save_dir"], "static_usad")
    ensure_dir(save_dir)
    ...
    # 构建静态边（与 dynamic_usad/train.py 完全相同）
