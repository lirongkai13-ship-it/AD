...
from variant_model import ABC_USAD; TEMPORAL_MODE = "per_variable_residual_ms_tcn"
...
def main():
    ...
    save_dir = os.path.join(cfg["output"]["save_dir"], "abc_r_v2")
    ensure_dir(save_dir)
    ...
    model = ABC_USAD(temporal_mode=TEMPORAL_MODE, 
