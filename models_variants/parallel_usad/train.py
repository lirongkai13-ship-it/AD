"""训练: Parallel Spatial-Temporal USAD"""
...
from variant_model import Parallel_USAD
...
def main():
    ...
    save_dir = os.path.join(cfg["output"]["save_dir"], "parallel_usad")
    ensure_dir(save_dir)
    ...
    print(f"\n=== Parallel Spatial-Temporal USAD ===")
