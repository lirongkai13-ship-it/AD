"""Train v5: v1 learnable + temporal position embedding"""
...
def main():
    ...
    save_dir = os.path.join(cfg["output"]["save_dir"], "tri_branch_v5")
    ensure_dir(save_dir)
    ...
    print(f"v5: v1 learnable + position embedding")
    ...
    print(f"\n=== v5 (v1+pos_emb, gamma={final_gamma:.4f}) ===")
