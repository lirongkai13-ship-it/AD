"""Train tri_branch_v4: attention pooling + expand + vector gate + learnable gamma"""
...
from models_variants.tri_branch_v4.variant_model import TriBranch_USAD_v4
...
def main():
    ...
    save_dir = os.path.join(cfg["output"]["save_dir"], "tri_branch_v4")
    ensure_dir(save_dir)
    ...
    print(f"v4: attention pooling + expand + vector gate + learnable gamma")
