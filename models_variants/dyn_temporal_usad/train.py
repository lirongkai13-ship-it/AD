"""训练: Dynamic Pearson + Temporal Attention + USAD"""
...
from variant_model import DynTA_USAD
...
def main():
    ...
    save_dir = os.path.join(cfg["output"]["save_dir"], "dyn_temporal_usad")
    ensure_dir(save_dir)
